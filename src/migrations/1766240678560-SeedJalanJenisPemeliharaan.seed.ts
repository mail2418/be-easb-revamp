    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        const data = [
            ...
            },
            {
                ...
                jenis_pemeliharaan: 'ringan',
                deskripsi: 'Kerusakan cukup berat sehingga lapisan perkerasan dan struktur bawahnya perlu diperbaiki',
                ruang_lingkup: 'Rekonstruksi sebagian lapisan pondasi\n\tPenggantian sebagian lapisan perkerasan rusak'
            },
            {
                tingkat_pemeliharaan: 'Rehabilitasi Jalan',
                jenis_pemeliharaan: 'berat',
        ...
        for (const item of data) {
            await queryRunner.query(
                ...
                [item.tingkat_pemeliharaan, item.jenis_pemeliharaan, item.ruang_lingkup, item.deskripsi],
            );
        }
    }
