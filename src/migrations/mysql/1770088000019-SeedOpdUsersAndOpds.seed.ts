...
export class SeedOpdUsersAndOpds1770088000019 implements MigrationInterface {
    name = 'SeedOpdUsersAndOpds1770088000019';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (!seedPassword) {
            throw new Error(
                'SEED_DEFAULT_PASSWORD environment variable is required for seeding OPD users',
            );
        }
        ...
        const opdData = [
            ...
            {
                username: 'UserDKBPPDPA',
                opd: 'Dinas Keluarga Berencana, Pemberdayaan Perempuan Dan Perlindungan Anak',
                alias: 'DKBPPDPA',
            },
        ...
        for (const data of opdData) {
            // Insert user - using JSON string for roles (simple-json column type)
