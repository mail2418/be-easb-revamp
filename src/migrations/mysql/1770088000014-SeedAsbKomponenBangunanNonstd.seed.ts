...
export class SeedAsbKomponenBangunanNonstd1770088000014 implements MigrationInterface {
    name = 'SeedAsbKomponenBangunanNonstd1770088000014';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            INSERT IGNORE INTO \`asb_komponen_bangunan_nonstd\` (\`komponen\`, \`files\`, \`id_asb_jenis\`, \`id_asb_tipe_bangunan\`) VALUES
