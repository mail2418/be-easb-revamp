...
@Injectable()
export class JalanSaluranSpesifikasiSmkkReviewRepositoryImpl
    implements JalanSaluranSpesifikasiSmkkReviewRepository
{
    constructor(
        @InjectRepository(JalanSaluranSpesifikasiSmkkReviewOrmEntity)
        private readonly repo: Repository<JalanSaluranSpesifikasiSmkkReviewOrmEntity>,
    ) {}
