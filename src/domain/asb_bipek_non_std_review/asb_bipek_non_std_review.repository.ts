...
export abstract class AsbBipekNonStdReviewRepository {
    abstract create(dto: CreateAsbBipekNonStdReviewDto): Promise<AsbBipekNonStdReview>;
    abstract update(dto: UpdateAsbBipekNonStdReviewDto): Promise<AsbBipekNonStdReview>;
    ...
    abstract getBpnsWithRelationByAsb(
        dto: GetAsbBipekNonStdReviewByAsbDto,
    ): Promise<[data: BpnsReviewWithRelationsDto[], total: number]>;
