...
export abstract class JalanSaluranSpesifikasiSmkkRepository {
    ...
    abstract findByUsulanSaluran(idUsulanSaluran: number, page?: number, amount?: number): Promise<[JalanSaluranSpesifikasiSmkk[], number]>;
    abstract findByUsulan(idUsulan: number, idJenisUsulan: number, page?: number, amount?: number): Promise<[JalanSaluranSpesifikasiSmkk[], number]>;
}
