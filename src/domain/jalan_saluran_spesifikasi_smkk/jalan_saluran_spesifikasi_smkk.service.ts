...
export abstract class JalanSaluranSpesifikasiSmkkService {
    ...
    abstract getByUsulanJalan(dto: GetJalanSaluranSpesifikasiSmkkByUsulanJalanDto): Promise<{ data: JalanSaluranSpesifikasiSmkk[]; total: number; page: number; amount: number; totalPages: number }>;
}
