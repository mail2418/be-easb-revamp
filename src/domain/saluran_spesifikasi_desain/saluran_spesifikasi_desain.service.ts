...
export abstract class SaluranSpesifikasiDesainService {
    abstract create(dto: CreateSaluranSpesifikasiDesainDto, lebar?: number): Promise<SaluranSpesifikasiDesain>;
    ...
    abstract findAll(dto: GetSaluranSpesifikasiDesainDto): Promise<SaluranSpesifikasiDesainPaginationResultDto>;
    abstract deleteByUsulanSaluranId(idUsulanSaluran: number): Promise<void>;
    abstract getByUsulanSaluran(dto: GetSaluranSpesifikasiDesainByUsulanSaluranDto): Promise<{ data: SaluranSpesifikasiDesain[]; total: number; page: number; amount: number; totalPages: number }>;
}
