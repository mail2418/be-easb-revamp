...
@Injectable()
export class JalanSpesifikasiDesainReviewServiceImpl
    implements JalanSpesifikasiDesainReviewService
{
    constructor(
    ...
    ): Promise<JalanSpesifikasiDesainReviewPaginationResultDto> {
    ...
    async getByUsulanJalan(dto: GetJalanSpesifikasiDesainReviewByUsulanJalanDto): Promise<{
