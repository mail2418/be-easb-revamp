...
@Injectable()
export class SaluranSpesifikasiSmkkReviewServiceImpl
    implements SaluranSpesifikasiSmkkReviewService
{
    ...
    async getByUsulanSaluran(dto: GetSaluranSpesifikasiSmkkReviewByUsulanSaluranDto): Promise<{
        data: SaluranSpesifikasiSmkkReview[];
        total: number;
        page: number;
        amount: number;
        totalPages: number;
