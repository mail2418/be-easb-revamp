...
@Module({
    imports: [
        TypeOrmModule.forFeature([JalanSaluranSpesifikasiSmkkReviewOrmEntity]),
    ...
    exports: [
        JalanSaluranSpesifikasiSmkkReviewService,
        JalanSaluranSpesifikasiSmkkReviewRepository,
    ],
})
